    ...
    <li class="nav-item static-item">
     ...
     <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="home" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute('admindashboard')}}" aria-current="page" href="{{route('admindashboard')}}">
                  <i class="icon">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute('admindashboard')}}" href="{{route('admindashboard')}}">
                    <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
        ...
        <ul class="sub-nav collapse" id="sidebar-special" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute('supercategory.index')}}" href="{{route('supercategory.index')}}">
                    ...
                    <span class="item-name">Super category </span>
                </a>
            </li>
            <li class="nav-item">
