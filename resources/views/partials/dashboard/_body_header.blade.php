                ...
                <div class="card-body p-0">
                    <a href="#" class="iq-sub-card">
                      <div class="d-flex align-items-center">
                          <img class="avatar-40 rounded-pill" src="{{asset('images/layouts/01.png')}}" alt="">
                    ...
                    <a href="#" class="iq-sub-card">
                      <div class="d-flex align-items-center">
                          <div class="">
                            <img class="avatar-40 rounded-pill" src="{{asset('images/layouts/02.png')}}" alt="">
                          </div>
                          <div class="ms-3 w-100">
                    ...
                    <a href="#" class="iq-sub-card">
                      <div class="d-flex align-items-center">
                          <img class="avatar-40 rounded-pill" src="{{asset('images/layouts/03.png')}}" alt="">
                          <div class="ms-3 w-100">
                    ...
                    <a href="#" class="iq-sub-card">
                      <div class="d-flex align-items-center">
                          <img class="avatar-40 rounded-pill" src="{{asset('images/layouts/04.png')}}" alt="">
